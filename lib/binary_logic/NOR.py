...
def test_NOR_00():
    ...
    assert mapping[result_node] == mapping[TRI_BIT_TO_NODE[TriBit.ONE]], "NOR operation did not return 1 for 00 input"
...
def test_NOR_01():
    ...
    assert mapping[result_node] == mapping[TRI_BIT_TO_NODE[TriBit.ZERO]], "NOR operation did not return 0 for 01 input"
...
def test_NOR_10():
    ...
    assert mapping[result_node] == mapping[TRI_BIT_TO_NODE[TriBit.ZERO]], "NOR operation did not return 0 for 10 input"
...
def test_NOR_11():
    ...
    assert mapping[result_node] == mapping[TRI_BIT_TO_NODE[TriBit.ZERO]], "NOR operation did not return 0 for 11 input"
