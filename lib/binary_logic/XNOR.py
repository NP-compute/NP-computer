...
def test_XNOR_00():
    ...
    assert mapping[result_node] == mapping[TriBit.ONE], "XNOR operation did not return 1 for 00 input"
...
def test_XNOR_01():
    ...
    assert mapping[result_node] == mapping[TriBit.ZERO], "XNOR operation did not return 0 for 01 input"
...
def test_XNOR_10():
    ...
    assert mapping[result_node] == mapping[TriBit.ZERO], "XNOR operation did not return 0 for 10 input"
...
def test_XNOR_11():
    ...
    assert mapping[result_node] == mapping[TriBit.ONE], "XNOR operation did not return 1 for 11 input"
