...
def test_NAND_00():
    ...
    assert mapping[result_node] == mapping[TRI_BIT_TO_NODE[TriBit.ONE]], "NAND operation did not return 1 for 00 input"
...
def test_NAND_01():
    ...
    assert mapping[result_node] == mapping[TRI_BIT_TO_NODE[TriBit.ONE]], "NAND operation did not return 1 for 01 input"
...
def test_NAND_10():
    ...
    assert mapping[result_node] == mapping[TRI_BIT_TO_NODE[TriBit.ONE]], "NAND operation did not return 1 for 10 input"
...
def test_NAND_11():
    ...
    assert mapping[result_node] == mapping[TRI_BIT_TO_NODE[TriBit.ZERO]], "NAND operation did not return 0 for 11 input"
